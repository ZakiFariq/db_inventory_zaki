                ...
                while($result=mysqli_fetch_assoc($query)){
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="hapus.php?id_barang=<?php echo $result['id_barang']?>" onclick="return confirm('Kamu yakin ingin menghapus barang ini?')" class="btn btn-danger"><i class="fa-solid fa-trash"></i>Hapus</a>
                        </td>
                    </tr>
                <?php
                $no++;
